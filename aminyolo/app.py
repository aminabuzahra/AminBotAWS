...
secrets_manager_name = "amin-aws-secrets"
...
def consume():
    ...
    while True:
        ...
        if 'Messages' in response:
            ...
            except botocore.exceptions.ClientError as amin_exception:
                if amin_exception.response['Error']['Code'] == "404":
                    logger.error("The image does not found")
                else:
                    logger.error(amin_exception)
                    raise
            ...
            except Exception as amin_exception:
                logger.error(amin_exception)
                raise
